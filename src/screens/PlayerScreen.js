...
import {Button, Dialog, Divider, Menu, Modal, Portal} from 'react-native-paper';
import {Dropdown} from 'react-native-element-dropdown';

const PlayerScreen = ({navigation, route}) => {
  const {streamData, movie, logo} = route.params;
          ...
          {showControls && (
            <View style={styles.controlsContainer}>
              <View style={styles.topBar}>
                ...
                <Text style={styles.videoInfo}>{movie.title}</Text>
                <TouchableOpacity onPress={event => showServerDialog(event)}>
